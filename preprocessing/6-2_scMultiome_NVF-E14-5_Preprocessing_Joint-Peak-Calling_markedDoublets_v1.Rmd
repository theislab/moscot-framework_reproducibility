...
```{r}
saveRDS(seurat, "/home/michi/Projects/scMultiome_NVF_Mouse-Pancreas-Development_E14.5_Notebooks/Files/E14-E15_adata_filtered_markedDoublets_seurat.rds")
saveRDS(seurat_list, "/home/michi/Projects/scMultiome_NVF_Mouse-Pancreas-Development_E14.5_Notebooks/Files/E14-E15_adata_filtered_markedDoublets_list_seurat.rds")
```
...
saveRDS(seurat, "/home/michi/Projects/scMultiome_NVF_Mouse-Pancreas-Development_E14.5_Notebooks/Files/E14-E15_adata_filtered_markedDoublets_seurat_jointPeaks.rds")
```

```{r}
# export peak count matrix
HDF5Array::writeTENxMatrix(x = macs2_counts, file="/home/michi/Projects/scMultiome_NVF_Mouse-Pancreas-Development_E14.5_Notebooks/Files/E14-E15_adata_filtered_markedDoublets_seurat_jointPeaks_peaks_count_matrix.h5")
write.table(x = rownames(macs2_counts), file = "/home/michi/Projects/scMultiome_NVF_Mouse-Pancreas-Development_E14.5_Notebooks/Files/E14-E15_adata_filtered_markedDoublets_seurat_jointPeaks_peaks_count_matrix_features.txt", col.names = FALSE, row.names = FALSE)
write.table(x = colnames(macs2_counts), file = "/home/michi/Projects/scMultiome_NVF_Mouse-Pancreas-Development_E14.5_Notebooks/Files/E14-E15_adata_filtered_markedDoublets_seurat_jointPeaks_peaks_count_matrix_barcodes.txt", col.names = FALSE, row.names = FALSE)
```
